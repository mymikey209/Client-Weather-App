...
todayHere();
// fetch('https://api.openweathermap.org/data/2.5/weather?lat=37.797&lon=-121.216')



async function ApiCall(today){
    const promise = await fetch('https://api.openweathermap.org/data/2.5/weather?lat=37.797&lon=-121.216&appid=2d380a5e9e23c1b1a805cb1d2431b6b4')
